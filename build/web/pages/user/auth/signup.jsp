                                ...
                                <form action="signup" method="post">
                                    <div class="form-group py-2">
                                        <div class="input-field">
                                            ...
                                            <input type="text" placeholder="Username or Email" name="suser" " required> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group py-1 pb-2">
                                        <div class="input-field"> 
                                            <span class="fas fa-lock px-2"></span> 
                                            <input type="password" placeholder="Enter your Password" name="re-pass"  required> 
                                            <button class="btn bg-white text-muted"> <span class="far fa-eye-slash"></span> </button> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center pt-4 text-muted">Do you want to <a href="alogin">Login</a> </div>
                                </form>
                            </div>
